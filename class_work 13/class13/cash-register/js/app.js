...
// the new line is appended to the <tbody id="entries">
// 3: #total is updated to reflect the sum of all the #entries
//
// Instructions:
// 1: Add a .submit event to the form; 
// use an anonymous function to handle the sumbit
...
// 6: Figure out a way to update the number in #total (Hint: 
// look back at the calculator box example)
...
$(document).ready(function () {
	...
	$('form').submit(function(event){
		...
		var newData = parseFloat($('#newEntry').val()); 


		$('#entries').append('<tr><td>' + newData + '</td></tr>');
		...
		// 	console.log($('td')[index].html());
		// var tdTotal = 0;

		// $("td").map( function(index, element) {
		//     // console.log($(this).html());
		//     tdTotal = tdTotal + parseFloat($(this).html());
		// 	console.log(tdTotal);
		// }).get();
